...
insert into sd.users(id, user_id, date_of_birth, email_address, full_name) values (6, 'palpatine', '1875-4-9', 'senator.palpatine@naboo.galaxy', 'Senator Palpatine')
...
insert into sd.users(id, user_id, date_of_birth, email_address, full_name) values (8, 'vader', '1936-6-6', 'darth.vader@empire.galaxy', 'Darth Vader')
insert into sd.users(id, user_id, date_of_birth, email_address, full_name) values (9, 'leia', '1959-11-11', 'leia.organa@alderaan.galaxy', 'Leia Organa')
insert into sd.users(id, user_id, date_of_birth, email_address, full_name) values (10, 'luke', '1959-11-11', 'luke.skywalker@tatooine.galaxy', 'Luke Skywalker')
insert into sd.users(id, user_id, date_of_birth, email_address, full_name) values (11, 'han', '1947-7-3', 'han.solo@corellia.galaxy', 'Han Solo')
insert into sd.users(id, user_id, date_of_birth, email_address, full_name) values (12, 'boba', '1957-8-1', 'boba.fett@mandalore.galaxy', 'Boba Fett')
insert into sd.users(id, user_id, date_of_birth, email_address, full_name) values (13, 'emperor', '1875-4-9', 'emperor@empire.galaxy', 'Emperor Palpatine')
...
insert into sd.groups(id, group_name, description, group_owner) values (5, 'sith', 'Sith', 6)
insert into sd.groups(id, group_name, description, group_owner) values (6, 'empire', 'Galactic Empire', 13)
insert into sd.groups(id, group_name, description, group_owner) values (7, 'rebels', 'Rebel Alliance', 9)
insert into sd.groups(id, group_name, description, group_owner) values (8, 'mandalorians', 'Mandalorians', 7)
insert into sd.groups(id, group_name, description, group_owner) values (9, 'resistance', 'Resistance', 9)
